...
- 任意算符实现都必须可追溯到 `./standards/en/01-core/01-00-FOCK_SLATER.md` 的 `basis_id_from`/`basis_id_to` 与 bit 规则。
...
- bitstring 作用规则继承 `./standards/en/01-core/01-00-FOCK_SLATER.md`。
- 原语作用符号由 $(-1)^{N_{<p}}$ 给出。
