...
## 4) 对 03-00/03-01 的约束
- `./standards/en/03-representations/03-00-REPRESENTATION_LSMS.md` 必须引用本文件的 $L_\pm,S_\pm,L_z,S_z$ 定义。
- `./standards/en/03-representations/03-01-REPRESENTATION_LSJM.md` 必须引用本文件的 $J_\pm,J_z$ 一致性定义。
