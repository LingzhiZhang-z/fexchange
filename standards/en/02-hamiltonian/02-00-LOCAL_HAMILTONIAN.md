...
- `O2/O4/O6`: rank-resolved Coulomb operators (defined in `./standards/en/02-hamiltonian/02-01-HINT.md`).
...
- Adopt the operator definition from `./standards/en/02-hamiltonian/02-02-HSOC.md`.
...
- Allow only symmetry branches defined in `./standards/en/02-hamiltonian/02-03-HCEF.md`.
