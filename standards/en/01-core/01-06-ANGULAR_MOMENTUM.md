...
- `./standards/en/03-spectrum/03-00-LSMS.md` MUST use this file for $L_\pm,S_\pm,L_z,S_z$ definitions.
- `./standards/en/03-spectrum/03-01-LSJM.md` MUST use this file for $J_\pm,J_z$ consistency.
